...
public class LogsCenter {
    ...
    private static final String LOG_FILE = "rosterbolt.log";
    ...
    /**
     * Creates a logger named 'rosterbolt', containing a {@code ConsoleHandler} and a {@code FileHandler}.
     * Sets it as the {@code baseLogger}, to be used as the parent logger of all other loggers.
     */
    private static void setBaseLogger() {
        baseLogger = Logger.getLogger("rosterbolt");

    ...
    public void readPersons_validCsv_returnsParsedPersons() throws Exception {
        ...
        Files.writeString(inputFile, String.join(System.lineSeparator(),
                ...
                "Alice Pauline,94351253,alice@example.com,\"123, Jurong West Ave 6\",Leader,Experienced,"
                        +
                        "friend;driver,\"MONDAY,09:00,12:00;TUESDAY,14:00,17:00\",\"2026-03-20T09:00,2026-03-20T12:00\""
        ));

        CsvReaderUtil.CsvImportFileResult result = CsvReaderUtil.readPersons(inputFile);
